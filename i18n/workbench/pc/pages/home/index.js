...
Date.prototype.format = function (fmt) {
  var o = {
      "M+": this.getMonth() + 1, //$i18n{index.js0}$i18n-end
      "d+": this.getDate(), //$i18n{index.js1}$i18n-end
      "h+": this.getHours(), //$i18n{index.js2}$i18n-end
      "m+": this.getMinutes(), //$i18n{index.js3}$i18n-end
      "s+": this.getSeconds(), //$i18n{index.js4}$i18n-end
      "q+": Math.floor((this.getMonth() + 3) / 3), //$i18n{index.js5}$i18n-end
      "S": this.getMilliseconds() //$i18n{index.js6}$i18n-end
  };
