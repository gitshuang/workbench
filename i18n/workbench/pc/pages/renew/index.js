...
class Account extends Component {
  ...
  render() {
    ...
    return (
      <ApplicationWrap
        name={brmVal.length <= 1 ? '$i18n{index.js0}$i18n-end' : brmVal[brmVal.length - 1].name}
        brms={brmVal.length === 0 ? [{ name: '$i18n{index.js1}$i18n-end' }] : brmVal.slice(0, brmVal.length - 1)}
      >
