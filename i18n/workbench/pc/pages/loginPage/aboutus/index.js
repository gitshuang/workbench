    ...
    return (
        <div className={AboutUsPanel}>
           ...
           <div className="mainCon">
                <div className="title">$i18n{index.js1}$i18n-end</div>
                <div className="absoutUsCon">
                    <div className="lefCon">
                        <span className="subtitle">$i18n{index.js2}$i18n-end</span>
                        <span className="desc">$i18n{index.js3}$i18n-end</span>
                        <span className="desc">$i18n{index.js4}$i18n-end-86393388$i18n{index.js5}$i18n-end</span>
                        <span className="desc">$i18n{index.js6}$i18n-endesnservice@yonyou.com</span>
