      ...
      <ul className={moreList} >
        {
          mores.map(({ id, name, serviceCode }) => (
            <li
              ...
              <button
                title={tabs.length === 1 ? "$i18n{index.js0}$i18n-end" : ""}
        ...
        <li
          ...
          <div className={moreName}>$i18n{index.js2}$i18n-end</div>
        </li>
      </ul>
    ) : null;
    const moreAreaElm = mores.length ? (
      <div className={moreArea}>
        <button
          ...
          onClick={this.toggleMore}><Icon title="$i18n{index.js3}$i18n-end" className={moreBtnArrow} type="upward"></Icon></button>
        { moreListElm }
      </div>
    ) : null;
            ...
            tabs.map(({ id, name, serviceCode }) => (
              <li
                ...
                <button
                  ...
                  onClick={this.del(id)} >
                  <Icon
                    title={tabs.length === 1 ? "$i18n{index.js4}$i18n-end" : ""}
                    type="error3" />
                </button>
              </li>
            ))
