        ...
        <div className={`${est_context}`}>
          <div className={box}>
            ...
            <div style={{textAlign:"center"}}>
              <button onClick={this.openTeam}>$i18n{index.js14}$i18n-end</button>
            </div>
          </div>
          <div className={box}>
          <div className={imageBox}>
            ...
            <div className={`${content} ${enter_context_div}`}>
              ...
              <ul className="clearfix">
                ...
                <li>$i18n{index.js20}$i18n-end</li>
                <li>$i18n{index.js21}$i18n-end</li>
            ...
            <div style={{textAlign:"center"}}>
              <button onClick={this.openEnter}>$i18n{index.js26}$i18n-end</button>
            </div>
          </div>
        </div>
      </div>
