        ...
        <ul className={recently}>{renderItems}</ul>
        {
          isShownodataClassEach ? null :
            <div className={nodataClass}>
              <img src={nodata} alt="$i18n{index.js2}$i18n-end" />
          ...
          <div className={`${wrap} ${clearfix} um-content um-vbox`}>
            <div className={searchPanel}>
              <FormControl
                ...
                placeholder="$i18n{index.js4}$i18n-end"
              ...
              <div className={search_icon_con}>
                ...
                <span className={search_tit} onClick={this.btnSearch}>$i18n{index.js5}$i18n-end</span>
              </div>
            </div>
