      ...
      get('/service/getServiceByTenantIdAndServiceCode', {
        ...
        if (!crossTenant) {
          openGlobalDialog({
            ...
            title: '$i18n{regMessageTypeHandler.js0}$i18n-end',
            content: '$i18n{regMessageTypeHandler.js1}$i18n-end',
            btns: [
              {
                label: '$i18n{regMessageTypeHandler.js2}$i18n-end',
                fun: () => {
                  const {
                    location: {
                      origin,
              ...
              {
                label: '$i18n{regMessageTypeHandler.js3}$i18n-end',
              },
            ],
          });
        } else {
