      ...
      <div className={'u-form-submit'}>
        {
          this.props.disabled
            ?
            <ButtonBrand onClick={this.click} ></ButtonBrand>
            :
      ...
      <div className={team_cont}>
        ...
        <div className={form_team}>
          <Form submitCallBack={this.checkForm} showSubmit={false} className={enter_form}>
            <FormItem showMast={false} labelName={<span><font color='red'> &nbsp;*&nbsp;</font></span>}
              isRequire={true} valuePropsName='value' errorMessage="" method="blur"
              inline={true}>
              <FormControl name="tenantName" value={tenantName ? tenantName : ""} onChange={(e) => { this.inputOnChange(e, "tenantName") }} placeholder="" />
            </FormItem>

            <FormItem showMast={false} labelName={<span><font color='red'> &nbsp; &nbsp;</font></span>} valuePropsName='value' method="change" inline={true}>
              <Upload name='logo' logo={logo ? logo : ""} onChange={this.onChangeUpload} />
            </FormItem>

            <FormItem showMast={false} labelName={<span><font color='red'>&nbsp;*&nbsp;</font></span>} isRequire={false} valuePropsName='value' errorMessage="" method="blur" inline={true}>
              <Select
                defaultValue="1"
            ...
            <FormItem showMast={false} labelName={<span><font color='red'> &nbsp;*&nbsp;</font></span>} isRequire={false} method="change" inline={true}>
            ...
            <FormItem showMast={false} labelName={<div><span></span><font color='red'> &nbsp;*&nbsp;</font></div>} isRequire={false} method="change" inline={true}>
