...
Date.prototype.format = function (fmt) {
  var o = {
      "M+": this.getMonth() + 1, //NoDictionary
      "d+": this.getDate(), //NoDictionary
      "h+": this.getHours(), //NoDictionary
      "m+": this.getMinutes(), //NoDictionary
      "s+": this.getSeconds(), //NoDictionary
      "q+": Math.floor((this.getMonth() + 3) / 3), //NoDictionary
      "S": this.getMilliseconds() //NoDictionary
  };
