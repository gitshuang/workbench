/**
 * Resolve response as JSON object
 *
 * @param response
 * @returns {*}
 */
...
/**
 * Obtain data attribute values. Rules:getStatus={data:{a:1}}，dataPro=data.a, then call this method and return getStatus['data']['a']，that is'1'
 *
 * @param dataPro
 * @param getStatus
 * @returns {*}
