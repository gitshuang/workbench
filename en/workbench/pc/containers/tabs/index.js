      ...
      <ul className={moreList} >
        {
          mores.map(({ id, name, serviceCode }) => (
            <li
              ...
              <button
                title={tabs.length === 1 ? "NoDictionary" : ""}
        ...
        <li
          ...
          className={more}
          title="NoDictionary" >
          <div className={moreName}>NoDictionary</div>
        </li>
      </ul>
    ) : null;
    const moreAreaElm = mores.length ? (
      <div className={moreArea}>
        <button
          ...
          onClick={this.toggleMore}><Icon title="NoDictionary" className={moreBtnArrow} type="upward"></Icon></button>
        { moreListElm }
      </div>
    ) : null;
