...
import {btn,default_btn,active_btn,disabled_btn} from './style_check_selected.css';
...
// type default
class ButtonCheckSelected extends Component {
...
ButtonCheckSelected.PropTypes = propTypes;
export default ButtonCheckSelected