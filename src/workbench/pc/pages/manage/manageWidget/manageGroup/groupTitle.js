...
const { addGroup, updateGroupList, selectGroupActions,selectListActions,delectGroup } = manageActions;
...
export default class GroupTitle extends React.Component{
  ...
  onDropSelect = (index) => ({ key }) => {
    ...
    renderTitle(){
        const {currEditonlyId,groupID ,index,selectGroup,widgetName,children } = this.props
