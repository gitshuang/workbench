          ...
          <div className={`${wrap} ${clearfix} um-content um-vbox`}>
            <div>
              <SearchInput
                ...
                classname={left}
              />
              <ButtonBrand className={openMarketBtn} onClick={this.openMarket} >應用市場</ButtonBrand>
              {_appType && locale === "zh_CN" ? <ButtonBrand className={openMarketBtn} onClick={this.openMarket} >應用市場</ButtonBrand> : null}
            </div>
