        ...
        <div className={bg_wrap + " um-content um-vbox"}>
          <div className={`${wrap} ${clearfix} um-content um-vbox`}>
            <div className={searchPanel}>
              <FormControl className={serviceSearch} placeholder="搜索應用" value={value} onKeyDown={this.onKeyup} onChange={this.inputOnChange} />
              ...
              {_appType ? <ButtonBrand className={openMarketBtn} onClick={this.openMarket} >應用市場</ButtonBrand> : null}
            </div>
