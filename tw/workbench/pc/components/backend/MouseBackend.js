...
export default class MouseBackend {
  constructor(manager) {
    ...
    this.handleWindowMove =
      this.handleWindowMove.bind(this);
  ...
  connectDropTarget(targetId, node) {
    ...
    const handleMove = this.handleMove.bind(this, targetId, node);
  ...
  handleWindowMoveCapture() {
    this.targetNodesObj = {};
    this.targetNodes = [];
    // this.moveStartSourceIds = [];
  }
  handleMove(targetId, node) {
  ...
  handleWindowMove(e) {
    ...
    if (!this.monitor.isDragging()
      && Object.prototype.hasOwnProperty.call(this.mouseClientOffset, 'x') && moveStartSourceIds &&
      (
    ...
    e.preventDefault();
    const { targetNodes, targetNodesObj } = this;
    this.targetNodes = [];
    this.targetNodesObj = {};
    const matchingTargetIds = targetNodes
      .filter((targetId) => {
        const boundingRect =
          targetNodesObj[targetId].getBoundingClientRect();
