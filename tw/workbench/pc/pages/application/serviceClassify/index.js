          ...
          <div className={`${wrap} ${clearfix} um-content um-vbox`}>
            <div>
              <SearchInput
                ...
                classname={left}
              />
              <ButtonBrand className={openMarketBtn} onClick={this.openMarket} ></ButtonBrand>
              {_appType && locale === "zh_CN" ? <ButtonBrand className={openMarketBtn} onClick={this.openMarket} ></ButtonBrand> : null}
            </div>
