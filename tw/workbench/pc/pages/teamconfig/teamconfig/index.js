    ...
    return (
      <div className={box2}>
        <div className={applicationBtns}>
          <span>
            <Button className={btnType == "web" ? active : ""} onClick={() => { this.changeDuan('web') }}>Web</Button>
            <Button className={btnType == "mob" ? active : ""} onClick={() => { this.changeDuan('mob') }}></Button>
            <Button className={btnType == "khd" ? active : ""} onClick={() => { this.changeDuan('khd') }}>PC</Button>
          </span>
          {/*<Button colors="danger"></Button>*/}
        </div>
                ...
                return (
                  <li className="um-box" key={index}>
                    ...
                    <div>
                      ...
                      {
                        item.expired ? <p>{this.handelTime(item.expired)}</p> : ""
                      }
                    </div>
                    <div>
                    ...
                    <div className="um-bf1 tr">
                      {
                        this.esitXufei(item.expired) ? <Button onClick={() => { this.openXufei(item.applicationId) }}></Button> : null
                      }
      ...
      <div className={box3}>
        <div className={memberTit}>
          <div className={search}>
            ...
            >
              <Icon type="search" />
              <span className={search_label}></span>
            </div>
          </div>
          <div className={memberBtns}>
            <Checkbox colors="info" onChange={this.changeCheck}></Checkbox>
            {
              _invitePermission ? <ButtonBrand onClick={this.inviteMember}></ButtonBrand> : null
            }
          </div>
        </div>

        <div className={table_title}>
          <div>{userList.totalElements}</div>
          <div className={table_permise}></div>
        </div>
                  ...
                  <li key={index}>
                    ...
                    <div className={`${option_sele} um-bf1  um-box-vc `}>
                      ...
                      >
                        ...
                        <Option value="deleteMember"></Option>
                      </Select>
                    </div>
                  </li>
                )
        ...
        <div className={header}>
          ...
          <div className="um-box um-box-center">
            <div style={{ float: "left" }}>
              <Button onClick={this.openUpgradeModal}></Button>
            </div>
            <div style={{ float: "left" }}>
              {/* <Dropdown
                trigger={['click']}
              ...
              >
                <Button className="um-box-vc um-box-center"><Icon type="pull-down" /></Button>
              </Dropdown> */}
              ...
              <EnterOption
                ...
                data={
                  [
                    { id: "aa", name: "", value: "2", serverApi: "team/remove", msg: "" },
                    { id: "allowExit", name: "", value: "3", serverApi: "team/leave", msg: "" },
                  ]
                }
              />
